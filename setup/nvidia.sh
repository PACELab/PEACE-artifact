...
sudo docker pull nba556677/ml_tasks:cuda_samples
#sudo docker pull nba556677/chatbot:vllm
...
if [ "$1" == "profile" ]
then
    echo "install nvidia nsys and ncu tool for profiling..."
...
#check mps status
sudo nvidia-cuda-mps-control -s
