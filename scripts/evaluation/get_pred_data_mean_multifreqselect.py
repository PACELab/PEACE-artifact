...
FREQ_DATASET_DIR = REPO_ROOT / "data" / "model_datasets"
FREQ_OUTPUT_DIR = REPO_ROOT / "artifacts" / "predictions"
STAGE2_DIR = REPO_ROOT / "data" / "colocations"
...
if __name__ == "__main__":
    ...
    if n_combinations == 2:
        ...
        #baselines
        mudi_summary_dir = BASELINE_EVALUATIONS_DIR / "mudi" / "curvefit" / "summary"
        gslice_summary_dir = BASELINE_EVALUATIONS_DIR / "gslice" / "summary"
        muxflow_summary_dir = BASELINE_EVALUATIONS_DIR / "muxflow"
        MUDI_LATENCY_OPTIMAL_ALLOCATION_FILES = {
        ...
        #added mudi baseline
        mudi_comb3_dir = BASELINE_EVALUATIONS_DIR / "mudi"
        MUDI_XPUT_OPTIMAL_ALLOCATION_FILES_POWERCAP = {
