...
file_path_power = f"{REPO_ROOT}/data/colocations/freq_motivation/09112025_share_comb2_freqscale_power_avg_stage2.csv"
file_path_power = f"{REPO_ROOT}/data/colocations/v100_socc26/triton_share_comb2_freqscale_power_avg_stage2.csv"
...
#file_path_throughput = f"{REPO_ROOT}/data/colocations/freq_motivation/09112025_share_comb2_freqscale_throughput_individual_avg.csv"
file_path_throughput = f"{REPO_ROOT}/data/colocations/v100_socc26/triton_share_comb2_freqscale_throughput_individual_avg.csv"
