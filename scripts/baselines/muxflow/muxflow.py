...
power_epsilon = 6
powercap_file_dict = {
    100: f"{REPO_ROOT}/data/model_datasets/05052025_nonDL_09152025_DL_mergecudaDL_powercap100_dvfs/merged_labels.csv",
    60:  f"{REPO_ROOT}/data/model_datasets/05052025_mergecudaDL_powercap60_dvfs/0505_nonDL_powercap60_dvfs_throughput_total_labels_comb2_labels.csv",
    200: f"{REPO_ROOT}/data/model_datasets/09102025_mergecudaDL_powercap200_dvfs/0910_powercap200_mergecudaDL_dvfs_throughput_total_labels_comb2_labels.csv"
}
powercapfile = powercap_file_dict[powercap_limit]
#powercapfile = f"{REPO_ROOT}/data/model_datasets/05052025_nonDL_09152025_DL_mergecudaDL_powercap100_dvfs/merged_labels.csv"
powercap_selected_freq_file = f"{REPO_ROOT}/results/paper/09152025_xput_under_powercap_mergecudaDL_unseen_multi_freq_powercap{powercap_limit}_epsilon{power_epsilon}_pred_vs_baselines_dvfs/summary_xput_under_powercap_all_pairs.csv"
powercap_result_file = f"powercap{powercap_limit}_result_optimal_percentages.csv"
freq300_path = f"{REPO_ROOT}/data/baseline_metrics/0506_FREQ300_baseline_metrics.csv"
freq900_path = f"{REPO_ROOT}/data/baseline_metrics/0502_FREQ900_baseline_metrics.csv"
freq1530_path = f"{REPO_ROOT}/data/baseline_metrics/0206_FREQ1530_baseline_metrics.csv"
...
shared_xput_root_dir = f"{REPO_ROOT}/data/colocations"
...
power_epsilon = 10
powercap_file_dict = {
    100: f"{REPO_ROOT}/data/model_datasets/rtxa6000/01312026_DL_powercap100_dvfs/merged_01312026_DL_powercap100_dvfs_throughput_total_labels_comb2_labels.csv"
}
powercapfile = powercap_file_dict[powercap_limit]
#powercapfile = f"{REPO_ROOT}/data/model_datasets/05052025_nonDL_09152025_DL_mergecudaDL_powercap100_dvfs/merged_labels.csv"
#f"{REPO_ROOT}/results/paper/rtxa6000/02062026_xput_under_powercap_comb2_mergecudaDL_unseen_multi_freq_powercap100_epsilon10_pred_vs_baselines_dvfs/summary_xput_under_powercap_all_pairs.csv"
powercap_selected_freq_file = f"{REPO_ROOT}/results/paper/rtxa6000/02062026_xput_under_powercap_comb2_mergecudaDL_unseen_multi_freq_powercap{powercap_limit}_epsilon{power_epsilon}_pred_vs_baselines_dvfs/summary_xput_under_powercap_all_pairs.csv"
powercap_result_file = f"powercap{powercap_limit}_result_optimal_percentages.csv"
available_freqs = ['300', '1200', '2100']
freq_path_dict = {}

for freq in available_freqs:
    freq_path_dict[f"freq{freq}_path"] = f"{REPO_ROOT}/data/baseline_metrics/rtxa6000/freq_{freq}.csv"
...
# Load the individual workload metrics file
# freq1530 this is for workload pair selection. NO other freq of shared throughput data should be used for this.
shared_xput_root_dir = f"{REPO_ROOT}/data/colocations/rtxa6000"
