...
Example:
    python artifacts/baseline_evaluations/mudi/find_missing_comb3_threads.py
"""
...
BASELINE_ROOT = REPO_ROOT / "artifacts" / "baseline_evaluations"
baseline = "gslice"
#baseline = "mudi"
#freq file paths can be used for different baselines.
FREQ_FILE_PATHS: Mapping[str, Path] = {
    "freq1530": Path(
        BASELINE_ROOT / baseline / "summary/freq1530_comb3_summary.csv"
        #"/curvefit/summary/cutoff_freq1530_comb3_optimal_allocation_latency.csv"
    ),
    "freq900": Path(
        BASELINE_ROOT / baseline / "summary/freq900_comb3_summary.csv"
        #"/curvefit/summary/cutoff_freq900_comb3_optimal_allocation_latency.csv"
    ),
    "freq300": Path(
        BASELINE_ROOT / baseline / "summary/freq300_comb3_summary.csv"
...
SELECTION_CONFIGS: List[Dict[str, object]] = [
    {
        "label": "powercap200",
        "path": REPO_ROOT / "results/paper"
        / "09152025_xput_under_powercap_comb3_mergecudaDL_unseen_multi_freq_powercap200_epsilon20_pred_vs_baselines_dvfs"
        / "summary_xput_under_powercap_all_pairs.csv",
        "powercap": 200,
        "output": Path(
            BASELINE_ROOT / baseline / f"{baseline}_missing_thread_powercap200.csv"
        ),
        "metrics_path": [
            Path(
                "data/model_datasets/09152025_shareDL_comb3_powercap200_dvfs/"
                "09152025_shareDL_comb3_powercap200_dvfs_throughput_total_labels_comb3_labels.csv"
            ),
            Path(
                "data/model_datasets/09152025_shareDL_comb3_powercap200_dvfs_mudi_baseline/"
    ...
    },
    {
        "label": "powercap100",
        "path": REPO_ROOT / "results/paper"
        / "09152025_xput_under_powercap_comb3_mergecudaDL_unseen_multi_freq_powercap100_epsilon10_pred_vs_baselines_dvfs"
        / "summary_xput_under_powercap_all_pairs.csv",
        "powercap": 100,
        "output": Path(
            BASELINE_ROOT / baseline / f"{baseline}_missing_thread_powercap100.csv"
        ),
        "metrics_path": [
            Path(
                "data/model_datasets/09152025_shareDL_comb3_powercap100_dvfs/"
                "09152025_shareDL_comb3_powercap100_dvfs_throughput_total_labels_comb3_labels.csv"
            ),
            Path(
                "data/model_datasets/09152025_shareDL_comb3_powercap100_dvfs_mudi_baseline/"
    ...
    },
    {
        "label": "powercap60",
        "path": REPO_ROOT / "results/paper"
        / "09152025_xput_under_powercap_comb3_mergecudaDL_unseen_multi_freq_powercap60_epsilon6_pred_vs_baselines_dvfs"
        / "summary_xput_under_powercap_all_pairs.csv",
        "powercap": 60,
        "output": Path(
            BASELINE_ROOT / baseline / f"{baseline}_missing_thread_powercap60.csv"
        ),
        "metrics_path": [
            Path(
                "data/model_datasets/09152025_shareDL_comb3_powercap60_dvfs_gpu012/"
                "09152025_shareDL_comb3_powercap60_dvfs_throughput_total_labels_comb3_labels.csv"
            ),
            Path(
                #"data/model_datasets/09152025_shareDL_comb3_powercap60_dvfs_mudi_baseline/"
                #"09152025_shareDL_comb3_powercap60_dvfs_mudi_baseline_throughput_total_labels_comb3_labels.csv"
                "data/model_datasets/09152025_shareDL_comb3_powercap60_dvfs_gpu012_missing_baseline/"
