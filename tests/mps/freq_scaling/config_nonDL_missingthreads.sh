...
CSV_FILE="/home/cc/mlProfiler/tests/mps/freq_scaling/dataset/05052025_FREQ300_nonDL_nodvfs/missing_entries/all_missing_combinations_with_powercap.csv"  # Replace with actual path

# Add valid frequency scaling factors (kept for potential future use)
VALID_FREQUENCY=300 #set to constant for now
TIMEOUT=999999999
