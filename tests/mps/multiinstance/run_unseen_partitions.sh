...
#300 remerge
#result_output_dir="../freq_scaling/output/05052025_FREQ300_mergecudaDL_nodvfs_remerge"
#900 remerge
#result_output_dir="../freq_scaling/output/05052025_FREQ900_mergecudaDL_nodvfs_remerge"
#1530 remerge
result_output_dir="../freq_scaling/output/09152025DL_0311nonDL_FREQ1530_mergecudaDL_nodvfs_remerge"

########################################################
#[SOCC'26 Rebuttal ONLY - triton kernel data]
#tritonkernel still use original 1530 metrics. not triton baseline metrics.
#result_output_dir="../freq_scaling/output/04132026_triton_FREQ1530_DL_nodvfs_BASELINE_NOTRITON"
#triton kernle with triton baseline metrics
#result_output_dir="../freq_scaling/output/04132026_triton_FREQ1530_DL_nodvfs_basemetric_TRITON"
########################################################
#COMB3 
#freq 300 
#result_output_dir="../freq_scaling/output/09152025_freq300_DL_comb3"
#freq900
#result_output_dir="../freq_scaling/output/09152025_freq900_DL_comb3"
#freq1530
#result_output_dir="../freq_scaling/output/09152025_freq1530_DL_comb3"
#####################
...
bash unseen_partitions.sh extratrees 0 $n_occur "$result_output_dir" train predict power "$rm_100partitions" "$n_combination"
bash unseen_partitions.sh extratrees 0 $n_occur "$result_output_dir" train predict throughput "$rm_100partitions" "$n_combination"
