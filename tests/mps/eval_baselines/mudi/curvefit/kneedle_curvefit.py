...
FIG_ROOT = Path("/home/cc/mlProfiler/tests/mps/eval_baselines/mudi/curvefit/fig")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=Path,
        nargs="+",
        default=[Path("tests/mps/freq_scaling/baseline_metrics/0206_FREQ1530_baseline_metrics.csv")],
    ...
    parser.add_argument(
        ...
        help="Sub-directory (relative to tests/mps/eval_baselines/mudi/curvefit/fig) used when --plot is enabled.",
    )
    parser.add_argument(
        "--summary_name",
        type=str,
