...
SUMMARY_ROOT = SCRIPT_DIR / "summary"
FIG_ROOT = SCRIPT_DIR / "fig"
...
#sample run 
"""
python tests/mps/eval_baselines/gslice/gslice_allocator.py --throughput_csv tests/mps/analysis/stage2/0311_freq1530_nonDL_nodvfs_share_comb2_freqscale_throughput_individual_avg.csv tests/mps/analysis/stage2/09152025_freq1530_nodvfs_share_comb2_freqscale_throughput_individual_avg.csv
--caps_csv tests/mps/eval_baselines/mudi/curvefit/summary/0206_xput_FREQ1530_kneedle_params_baseline.csv --arrival_csv tests/mps/freq_scaling/baseline_metrics/0206_FREQ1530_baseline_metrics.csv --summary_name freq1530_comb2_summary.csv --fig_dir colocated_freq1530 --log_level WARNING --n_comb 2
n comb ==3
python tests/mps/eval_baselines/gslice/gslice_allocator.py --throughput_csv tests/mps/analysis/stage2/09152025_freq300_DL_comb3_share_comb3_freqscale_throughput_individual_avg.csv
--caps_csv tests/mps/eval_baselines/mudi/curvefit/summary/single_freq300.csv --arrival_csv tests/mps/freq_scaling/baseline_metrics/0206_FREQ1530_baseline_metrics.csv --summary_name freq1530_comb3_summary.csv --fig_dir colocated_comb3_freq1530 --log_level WARNING --n_comb 3
"""
