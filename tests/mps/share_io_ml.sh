...
#BE_EPOCHS=(7 7) 
LS_PERCENTAGES=(10 30 50 70 90)
BE_PERCENTAGES=(90 70 50 30 10)
#LS_PERCENTAGES=(0)
#BE_PERCENTAGES=(100)
RUNS=2
    ...
    for ((i=0; i<${#LS_PERCENTAGES[@]}; i++)); do
        ...
        for TASK_MODEL in "${TASKS_MODELS[@]}"; do
            ...
            if [ $LS_PERCENTAGE -eq 0 ]; then
                ...
                # Start LS server
                echo "Starting LS server for io"
                #sudo export NVIDIA_VISIBLE_DEVICES=1
                export NVIDIA_VISIBLE_DEVICES=1
                NVIDIA_VISIBLE_DEVICES=1 CUDA_MPS_ACTIVE_THREAD_PERCENTAGE=${LS_PERCENTAGE}  sudo /home/cc/miniconda3/bin/python io/toy_movept.py --log_dir $CURR_LOG_DIR > /home/cc/mlProfiler/tests/mps/$CURR_LOG_DIR/LS_MPS${LS_PERCENTAGE}.log 2>&1 &
            fi
            ...
            sudo kill -15 $(pgrep -f "sudo /home/cc/miniconda3/bin/python")
