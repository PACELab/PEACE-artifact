...
class MLParser():
    ...
    def add_common_args(self):
        ...
        #DEBUG makeshift for now for autoregressive testing. should be in add inference args
        self.parser.add_argument("--output_length", type=int, default=2000)
        self.parser.add_argument("--num_requests", type=int, default=1000000000)
    ...
    def add_train_args(self) -> argparse.Namespace:
        ...
        self.parser.add_argument("--n_epoch", type=int, default=999999)
    ...
    def add_inference_args(self) -> argparse.Namespace:
        ...
        """
        #autoregressive
        #add input_text arguments
        self.parser.add_argument("--input_text", type=str, default="Once upon a time")
