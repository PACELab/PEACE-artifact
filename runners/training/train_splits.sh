...
EXCOL=""
#for splitting
root_dataset_dir="$REPO_ROOT/data/model_datasets/batch2-8/MPS100/trainratio_${n_occur}"
if [ "$modeltype" == "hotcloud" ]
then
    full_data_path="$REPO_ROOT/tests/mps/analysis/baselines/hotcloud/hotcloud_combined_noexclu_throughput_targetMPS100.csv"
else
    #KACE
    full_data_path="$REPO_ROOT/data/model_datasets/total_labels_batch2-8_targetMPS100.csv"
fi
