...
CSV_FILE='$REPO_ROOT/data/experiment_inputs/colocations/gpt2-xl_filtered_data.csv'
...
while IFS=, read -r workload1 workload2; do
    ...
    for RUN in $(seq 1 $RUNS); do 
        ...
        --batch_size ${batchsize1} --log_dir ../../$CURR_LOG_DIR --profile_nstep 3000 --output_length ${output_length1} --num_requests 12"  \
        ...
        --batch_size ${batchsize2} --log_dir ../../$CURR_LOG_DIR  --profile_nstep 3000 \
