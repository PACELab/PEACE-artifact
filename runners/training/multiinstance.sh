...
###CONSTANTS############################################################################################
#CSV_FILE='$REPO_ROOT/data/experiment_inputs/colocations/kernel_labels_comb3_batches2-8.csv'
#CSV_FILE='$REPO_ROOT/data/experiment_inputs/colocations/shuffled_comb4_batch2-8output.csv'
CSV_FILE='$REPO_ROOT/data/experiment_inputs/colocations/shuffled_exclude_oom_kernel_labels_comb4_fixedbatch4_with_batches2-8.csv'
...
while IFS=, read -r workload1 workload2 workload3 workload4; do
    ...
    for RUN in $(seq 1 $RUNS); do 
        ...
        --batch_size ${batchsize1} --log_dir ../../$CURR_LOG_DIR --profile_nstep 1000"  \
        ...
        --batch_size ${batchsize2} --log_dir ../../$CURR_LOG_DIR  --profile_nstep 1000"  \
        ...
        /bin/sh -c "cd /root/mlprofiler/workloads/${mode3}; python ${task3}-${mode3}.py --model_name ${prefix3}${workload_name3} \
         --batch_size ${batchsize3} --log_dir ../../$CURR_LOG_DIR  --profile_nstep 1000"  \
        ...
        /bin/sh -c "cd /root/mlprofiler/workloads/${mode4}; python ${task4}-${mode4}.py --model_name ${prefix4}${workload_name4} \
         --batch_size ${batchsize4} --log_dir ../../$CURR_LOG_DIR  --profile_nstep 1000"  \
