...
bash "$SCRIPT_DIR/unseen_testbatch.sh" KACE 0 $n_occur output/run0909_comb4_KACE_testbatch4_batch2-8  train  predict
#bash "$SCRIPT_DIR/unseen_partitions.sh" hotcloud 0 $n_occur output/run0907_comb4_KACE_batch2-8  train  predict
