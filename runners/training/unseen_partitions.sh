...
#root_dataset_dir="$REPO_ROOT/data/model_datasets/03112025_DL0207_0307_nonDL0311_nodvfs_FREQ1530/unseen_partition/$throughput_or_power_task"

#root_dataset_dir="$REPO_ROOT/data/model_datasets/05052025_FREQ900_mergecudaDL_nodvfs/unseen_partition/$throughput_or_power_task"
#root_dataset_dir="$REPO_ROOT/data/model_datasets/05052025_FREQ300_mergecudaDL_nodvfs/unseen_partition/$throughput_or_power_task"
#300 remerge
root_dataset_dir="$REPO_ROOT/data/model_datasets/05052025_FREQ300_mergecudaDL_nodvfs_remerge/unseen_partition/$throughput_or_power_task"
#900 remerge
root_dataset_dir="$REPO_ROOT/data/model_datasets/05052025_FREQ900_mergecudaDL_nodvfs_remerge/unseen_partition/$throughput_or_power_task"
#1530 remerge
root_dataset_dir="$REPO_ROOT/data/model_datasets/09152025DL_0311nonDL_FREQ1530_mergecudaDL_nodvfs_remerge/unseen_partition/$throughput_or_power_task"
########################################################
#[SOCC'26 Rebuttal ONLY - triton kernel data]
#tritonkernel still use original 1530 metrics. not triton baseline metrics.
#root_dataset_dir="$REPO_ROOT/data/model_datasets/04132026_triton_DL_socc26_basemetric_nontriton/unseen_partition/$throughput_or_power_task"
#triton kernle with triton baseline metrics

#root_dataset_dir="$REPO_ROOT/data/model_datasets/04132026_triton_DL_socc26_basemetric_TRITON/unseen_partition/$throughput_or_power_task"
########################################################
### COMB3/Users/bing/Documents/Documents - Bing’s MacBook Air/mlProfiler/data/model_datasets/09152025_freq300_DL_comb3/09152025_freq300_DL_comb3_throughput_total_labels_comb3.csv
#freq300
#root_dataset_dir="$REPO_ROOT/data/model_datasets/09152025_freq300_DL_comb3/unseen_partition/$throughput_or_power_task"
#freq900
#root_dataset_dir="$REPO_ROOT/data/model_datasets/09152025_freq900_DL_comb3/unseen_partition/$throughput_or_power_task"
#freq1530
#root_dataset_dir="$REPO_ROOT/data/model_datasets/09152025_freq1530_DL_comb3/unseen_partition/$throughput_or_power_task"

if [ "$modeltype" == "hotcloud" ]
then
    full_data_path="$REPO_ROOT/data/model_datasets/hotcloud/0907hotcloud_total_labels_comb4_batch2-8_targetMPS100.csv"
else
    #KACE
    #full_data_path="$REPO_ROOT/data/model_datasets/KACE/0909_total_labels_comb4_testbatch4_batch2-8_targetMPS100.csv"
    #full_data_path="$REPO_ROOT/data/model_datasets/KACE/0907_total_labels_comb4_batch2-8_targetMPS100.csv"
    ...
    then
        ...
        #full_data_path="$REPO_ROOT/data/model_datasets/05052025_FREQ900_mergecudaDL_nodvfs/0505_FREQ900_nodvfs_throughput_total_labels_comb2.csv"
        #full_data_path="$REPO_ROOT/data/model_datasets/05052025_FREQ300_mergecudaDL_nodvfs/0505_FREQ300_nodvfs_throughput_total_labels_comb2.csv"
        #full_data_path="./dataset/03112025_DL0207_0307_nonDL0311_nodvfs/mergecudaDL_nodvfs_throughput_total_labels_comb2.csv"
        
        #comb 2
        #300 remerge
        #full_data_path="$REPO_ROOT/data/model_datasets/05052025_FREQ300_mergecudaDL_nodvfs_remerge/merged_total_labels_comb2.csv"
        #900 remerge
        #full_data_path="$REPO_ROOT/data/model_datasets/05052025_FREQ900_mergecudaDL_nodvfs_remerge/merged_total_labels_comb2.csv"
        #1530 remerge
        full_data_path="$REPO_ROOT/data/model_datasets/09152025DL_0311nonDL_FREQ1530_mergecudaDL_nodvfs_remerge/merged_total_labels_comb2.csv"

        ########################################################
        #[SOCC'26 Rebuttal ONLY - triton kernel data]
        #tritonkernel still use original 1530 metrics. not triton baseline metrics.
        #full_data_path="$REPO_ROOT/data/model_datasets/04132026_triton_DL_socc26_basemetric_nontriton/triton_DL_throughput_total_labels_comb2.csv"
        #triton kernle with triton baseline metrics
        #full_data_path="$REPO_ROOT/data/model_datasets/04132026_triton_DL_socc26_basemetric_TRITON/triton_DL_throughput_total_labels_comb2.csv"
        ########################################################
        
        #COMB3
        #freq300
        #full_data_path="$REPO_ROOT/data/model_datasets/09152025_freq300_DL_comb3/09152025_freq300_DL_comb3_throughput_total_labels_comb3.csv"
        #freq900
        #full_data_path="$REPO_ROOT/data/model_datasets/09152025_freq900_DL_comb3/09152025_freq900_DL_comb3_throughput_total_labels_comb3.csv"
        #freq1530
        #full_data_path="$REPO_ROOT/data/model_datasets/09152025_freq1530_DL_comb3/09152025_freq1530_DL_comb3_throughput_total_labels_comb3_sampled.csv"
    else
        #full_data_path="$REPO_ROOT/data/model_datasets/05052025_FREQ900_nodvfs/0505_FREQ900_throughput_total_labels_comb2.csv"
...
then
    ...
    do
        ...
        do
            ...
            python "$REPO_ROOT/main.py" --test_file "$dataset_dir/$test_file" --train_file "$dataset_dir/$train_file" \
...
#Predict throughput for different workloads
    ...
    do
        ...
        do
            ...
            #model_dir="$REPO_ROOT/data/experiment_inputs/colocations/model"
            outdir_rand="$outdir/unseen_partition/${throughput_or_power_task}/rand${seed}/$modeltype/$workload"
            ...
            python "$REPO_ROOT/main.py"  --test_file "$dataset_dir/$test_file" \
            --train_file  "$dataset_dir/$train_file" \
            ...
            --predAllacc -comb $n_combination --label_policy $label_policy --debug
                ...
                #--sharedThroughputData /Users/bing/Library/CloudStorage/OneDrive-StonyBrookUniversity/SBU/mlsys/mlProfiler/data/colocations/merged0505_0617_0520_0624_share_steps_stage2.csv
